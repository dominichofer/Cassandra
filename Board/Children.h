...
namespace children
{
	struct PositionMoves
	{
		...
		CUDA_CALLABLE bool operator==(const PositionMoves& o) const noexcept { return pos == o.pos && moves == o.moves; }
		CUDA_CALLABLE bool operator!=(const PositionMoves& o) const noexcept { return !(*this == o); }
	};
	...
	public:
		...
		CUDA_CALLABLE bool operator==(const Iterator& o) const noexcept { return (plies == o.plies) && (pass_is_a_ply == o.pass_is_a_ply) && (stack == o.stack); }
