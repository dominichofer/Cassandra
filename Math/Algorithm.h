...
inline DenseMatrix CholeskyDecomposition(const DenseMatrix& A)
{
...
inline Vector ForwardSubstitution(const DenseMatrix& L, Vector b)
{
...
inline Vector BackwardSubstitution(const DenseMatrix& U, Vector b)
{
