...
{
	ASSERT_EQ(PossibleMoves(0x0000'0008'1000'0000ui64, 0x0000'0010'0800'0000ui64), 0x0000102004080000ui64);
}

TEST(PossibleMoves, start_position_eth)
{
	ASSERT_EQ(PossibleMoves(0x0000'0018'0000'0000ui64, 0x0000'0000'1800'0000ui64), 0x00000000003C0000ui64);
}
