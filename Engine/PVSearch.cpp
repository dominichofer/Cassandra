...
constexpr BitBoard Smear(BitBoard B) noexcept
{
...
// TODO: Move this function!
constexpr uint64_t OpponentsExposed(const Position& pos) noexcept
{
	// 13 OPs
	return Smear(pos.Empties()) & pos.O;
}
