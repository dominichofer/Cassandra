...
{
	uint64_t a;
	a = 0; ClearLSB(a); ASSERT_EQ(a, 0ULL);
	a = 1; ClearLSB(a); ASSERT_EQ(a, 0ULL);
	a = 2; ClearLSB(a); ASSERT_EQ(a, 0ULL);
	a = 3; ClearLSB(a); ASSERT_EQ(a, 2ULL);
	a = 0x8000000001000000ULL; ClearLSB(a); ASSERT_EQ(a, 0x8000000000000000ULL);
}
